...
#ifdef OS_USED
	// TODO 默认512，改大一点，实际测试需要3K，根据自己实际情况修改
	hal_thread_create(&demo_threadId, 3072, osPriorityNormal, data_template_demo_task, NULL);
	hal_thread_destroy(NULL);
#else
...
extern void start_user_task(void *arg);

void application_entry(void *arg)
{
	start_user_task(NULL);
