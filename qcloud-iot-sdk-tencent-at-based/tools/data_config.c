...
typedef struct _ProductDataDefine {
    ...
    TYPE_DEF_TEMPLATE_ENUM m_default_color;
} ProductDataDefine;
...
static void _init_data_template(void)
{
    ...
    sg_ProductData.m_default_color = 0;
    sg_DataTemplate[8].data_property.data = &sg_ProductData.m_default_color;
    sg_DataTemplate[8].data_property.key  = "default_color";
